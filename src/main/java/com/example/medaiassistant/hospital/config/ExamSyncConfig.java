...
public class ExamSyncConfig {
     ...
     * 模板文件名
     */
    private static final String TEMPLATE_FILE_NAME = "exam-results-query.json";

    /**
     * 查询名称
     */
    private static final String QUERY_NAME = "getExamResults";
     ...
     * 
     * <p>动态构建路径，避免硬编码医院名称。
     * 路径格式: sql/{hospitalId小写}/exam-results-query.json</p>
     * 
     * <p><strong>示例</strong>:
     * <ul>
     *   <li>hospital-Local → sql/hospital-local/exam-results-query.json</li>
     *   <li>testserver → sql/testserver/exam-results-query.json</li>
     *   <li>CDWYY → sql/cdwyy/exam-results-query.json</li>
     * </ul></p>
     * 
    ...
    public String getTemplateFilePath(String hospitalId) {
        ...
        String templatePath = String.format("%s%s/%s", 
            ...
            TEMPLATE_FILE_NAME);
        log.debug("构建检查结果模板路径 - 医院ID: {}, 路径: {}", hospitalId, templatePath);
        return templatePath;
    }
    ...
    public String getSummary() {
        return String.format(
            "ExamSyncConfig{defaultHospitalId='%s', templateFileName='%s', queryName='%s'}",
